...
In the code chunk below, \[*cor()*\](6.7.1 Getting started with corrplot Before we can plot a corrgram using corrplot(), we need to compute the correlation matrix of wine data frame.

In the code chunk below, cor() of R Stats is used to compute the correlation matrix of wine data frame.) of R Stats is used to compute the correlation matrix of wine data frame.
...
-   “hclust” for hierarchical clustering order, and<br> “hclust.method” for the agglomeration method to be used. “hclust.method” should be one of “ward”, “single”, “complete”, “average”, “mcquitty”, “median” or “centroid”.
...
-   [`ggscatmat`](https://ggobi.github.io/ggally/reference/ggscatmat.html) and [`ggpairs`](https://ggobi.github.io/ggally/reference/ggscatmat.html) of [**GGally**](https://ggobi.github.io/ggally/index.html).
...
::: {.callout-note title="Recommendation"}
Recommendation To learn more about pipe, visit this excellent article: Pipes in R Tutorial For Beginners. 
:::
...
```r
library(devtools) install_github("timelyportfolio/d3treeR")
```
